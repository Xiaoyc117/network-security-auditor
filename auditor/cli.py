...
ALL_MODULES = ["port", "ssl", "web", "compliance"]
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "  python main.py --target example.com --modules port,ssl\n"
    ...
    parser.add_argument("--modules", default="port,ssl,web,compliance", metavar="MODS",
                        help=f"选择模块,逗号分隔: {','.join(ALL_MODULES)};默认全部")
    parser.add_argument("--output", default="audit_report.html", metavar="PATH",
                        help="HTML 报告输出路径,默认 audit_report.html")
